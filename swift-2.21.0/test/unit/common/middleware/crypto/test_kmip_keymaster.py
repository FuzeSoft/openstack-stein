...
from swift.common.middleware.crypto.kmip_keymain import KmipKeyMain


KMIP_CLIENT_CLASS = \
    'swift.common.middleware.crypto.kmip_keymain.ProxyKmipClient'
...
class TestKmipKeymain(unittest.TestCase):
    ...
    def test_config_in_separate_file(self):
        ...
        conf = {'__file__': '/etc/swift/proxy-server.conf',
                '__name__': 'keymain-kmip',
                'keymain_config_path': km_config_file}
        ...
        self.assertEqual({None: b'x' * 32}, km._root_secrets)
        self.assertEqual(None, km.active_secret_id)
        self.assertEqual(km_config_file, km.keymain_config_path)
        self.assertEqual(calls, [
